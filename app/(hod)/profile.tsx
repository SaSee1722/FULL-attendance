      ...
      <ScrollView contentContainerStyle={styles.body}
        ...
        <LinearGradient colors={gradients.premium as any} style={[styles.profileHeader, { paddingTop: insets.top + 20 }]}>
          ...
          <Animated.View entering={FadeInDown.delay(200).duration(800)} style={styles.profileMeta}>
            ...
            <View style={styles.proBadge}>
              ...
              <Text style={styles.proBadgeText}>Admin Account</Text>
            </View>
        ...
        <Animated.View entering={FadeInUp.delay(400).duration(800)} style={[styles.statsPanel, shadows.premium]}>
          {[
            ...
            { label: 'Staff', value: stats.staff, icon: BadgeCheck, color: '#F59E0B' },
          ].map((s, i) => (
...
const styles = StyleSheet.create({
  ...
  editBtnText: { fontSize: 13, fontWeight: '800', color: colors.primaryBlue },
  ...
  version: { textAlign: 'center', color: '#CBD5E1', fontSize: 12, marginTop: spacing.lg, paddingBottom: 100, fontWeight: '700' },
  ...
  saveBtn: { backgroundColor: colors.primaryBlue, height: 56, borderRadius: 16, justifyContent: 'center', alignItems: 'center' },
